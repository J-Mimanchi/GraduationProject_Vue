<template>
  <div class="login-container">
    <div class="login-box">
      <div style="font-weight: bold; font-size: 24px; text-align: center; margin-bottom: 30px; color: #9f8be3">欢 迎 注 册</div>
...
const data = reactive({
  ...
  rules: {
    username: [
      ...
      { pattern: /^[a-zA-Z0-9]{3,10}$/, message: '账号只能是3到10位的英文或数字' }
    ],
    password: [
